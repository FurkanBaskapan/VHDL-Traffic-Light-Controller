...
architecture trafik of trafik is
...
if(rising_edge(clk)) then 
 ...
 if(counter_1s >= x"2FAF080") then -- x"0004" is for simulation
 -- change to x"2FAF080" for 50 MHz clock running real FPGA
  counter_1s <= x"0000000";
 end if;
end if;
end process;
clk_1s_enable <= '1' when counter_1s = x"2FAF080" else '0'; -- x"0002" is for simulation
