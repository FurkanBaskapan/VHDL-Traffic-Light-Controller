...
HD_PWD='C:/Users/hp/project_trafik/project_trafik.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trafik.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trafik.tcl -notrace
