...
HD_PWD='C:/Users/hp/project_trafik/project_trafik.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trafik.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trafik.tcl
